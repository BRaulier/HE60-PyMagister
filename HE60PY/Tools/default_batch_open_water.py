...
class OpenWaterDefaultBatch(RecordBuilder):
    ...
    def set_record8(self):
        ...
        if self.default['record8']['iflagsky'] == 2:
            ...
            self.default['record8']['sunphi'] = 0.0  # solar azimuthal angle in degrees relative to the wind direction.
            self.default['record8'][
                'C'] = 0.0  # Cardioidal parameter, 0.0: uniform sky, 2.0: cardioidal sky, 1.25: heavy overcast
    ...
    def set_record9(self):
        ...
        self.default['record9'][
            'refr'] = 1.33  # Refraction index: Maykut & Light, Refractive-index measurements in freezing sea-ice and sodium chloride brines
    ...
    def set_record12(self):
        ...
        self.default['record12'][
            'IrradDataFile'] = 'HE60DORT_irrad_trios_.txt'  # Standard-format data file containing sea-surface total Ed (if not using RADTRAN-X model)
        self.default['record12'][
